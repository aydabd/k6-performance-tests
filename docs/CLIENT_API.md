...
<dd><p>This file contains the HttpClientFactory class which is used to create a new HttpClient instance with a dynamic client proxy.</p>
</dd>
<dt><a href="#module_http-error-handler">http-error-handler</a></dt>
<dd><p>http-error-handler.js</p>
</dd>
</dl>
...
<dl>
<dt><a href="#BaseUrl">BaseUrl</a></dt>
<dd><p>Class representing the base URL for the API requests.</p>
</dd>
<dt><a href="#WSOptionsGenerator">WSOptionsGenerator</a></dt>
<dd><p>Class representing a generator for WebSocket options.</p>
</dd>
<dt><a href="#WebSocketClient">WebSocketClient</a></dt>
<dd><p>Class representing a WebSocket client.</p>
</dd>
</dl>
...
## http-client
This file contains the HttpClientFactory class which is used to create a new HttpClient instance with a dynamic client proxy.
...
**Kind**: inner constant of [<code>http-error-handler</code>](#module_http-error-handler)  
...
<a name="WSOptionsGenerator"></a>

## WSOptionsGenerator
Class representing a generator for WebSocket options.

**Kind**: global class  
<a name="new_WSOptionsGenerator_new"></a>
...
* [WebSocketClient](#WebSocketClient)
    * [.addEventListener(event, handler)](#WebSocketClient+addEventListener)
    * [.close(code, reason)](#WebSocketClient+close)
    * [.send(message)](#WebSocketClient+send)
    * [.startTimeout()](#WebSocketClient+startTimeout)
    * [.clTimeout()](#WebSocketClient+clTimeout)
    * [.signalRhubHandshake(protocol, version)](#WebSocketClient+signalRhubHandshake)
    * [.onSignalROpen()](#WebSocketClient+onSignalROpen)
    * [.onClose(message)](#WebSocketClient+onClose)
    * [.onError(message)](#WebSocketClient+onError)
    * [.setupSignalREventListeners()](#WebSocketClient+setupSignalREventListeners)
    * [.tearDown()](#WebSocketClient+tearDown)

<a name="WebSocketClient+addEventListener"></a>
...
```
<a name="WebSocketClient+close"></a>
...
```
<a name="WebSocketClient+startTimeout"></a>
...
socket.startTimeout();
```
<a name="WebSocketClient+clTimeout"></a>
...
socket.clTimeout();
```
<a name="WebSocketClient+signalRhubHandshake"></a>
...
<a name="WebSocketClient+onSignalROpen"></a>
...
socket.onError();
```
<a name="WebSocketClient+setupSignalREventListeners"></a>
...
```
<a name="WebSocketClient+tearDown"></a>
